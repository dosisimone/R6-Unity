...
[BurstCompile]
public struct MultiPolygonJobData : IDisposable
{
    [BurstCompile]
    ...
    public NativeList<byte> PolygonSupportList;

    public MultiPolygonJobData(Allocator allocator)
    {
        ...
        PolygonSupportList = new NativeList<byte>(allocator);
    }
